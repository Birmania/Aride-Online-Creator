...
Public Declare Function CallWindowProcThreading Lib "user32" Alias "CallWindowProcA" (ByVal lpPrevWndFunc As Long, ByVal hwnd As Long, ByVal Msg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
...
'thread object but VB won't know it.
        CallWindowProcThreading AddressOf ThreadWndProc, hwnd, Msg, wParam, lParam
        NewWndProc = 0
        Exit Function
    End If
     NewWndProc = CallWindowProcThreading(FormWndProc, hwnd, Msg, wParam, lParam)
End Function
...
If ReadFS18 = 0 Then _
    ReadFS18 = CallWindowProcThreading(VarPtr(SubFS18.Buffer(0)), 0, 0, 0, 0)
End Function
