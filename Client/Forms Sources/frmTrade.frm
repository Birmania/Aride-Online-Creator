...
Dim Ending As String
    ...
    For i = 1 To 4
        ...
        If FileExist(App.Path & "\" & Rep_Theme & "\Jeu\magasin" & Ending) Then Me.Picture = LoadPNG(App.Path & Rep_Theme & "\Jeu\magasin" & Ending)
    Next i
    
    Dim R1 As Long, G1 As Long, B1 As Long
    
    R1 = Val(ReadINI("BARE", "R", ColorConfigurationFile))
    G1 = Val(ReadINI("BARE", "G", ColorConfigurationFile))
...
If picFixItems.Tag >= 1 And picFixItems.Tag <= MAX_ITEMS Then
    ...
    If GetPlayerInvItemNum(MyIndex, 1) > 0 Then
        i = ((item(GetPlayerInvItemNum(MyIndex, 1)).Datas(0) - GetPlayerInvItemDur(MyIndex, 1)) * (item(GetPlayerInvItemNum(MyIndex, 1)).Datas(1) / 5)) \ 2
        If i <= 0 Then i = 1
