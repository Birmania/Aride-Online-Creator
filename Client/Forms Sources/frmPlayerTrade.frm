...
'
'                    Packet.WriteLong CUpdateTradeInv
'                    Packet.WriteInteger n 'Position in the list
'                    Packet.WriteInteger Trading(n).InvNum
'                    Packet.WriteLong Trading(n).InvVal
'
'                    SendData Packet.ToArray()
'                    Set Packet = Nothing

                    If frmPlayerTrade.Etat.Caption = "Accepter" Then
                        frmPlayerTrade.Etat.Caption = "En cours..."
                        frmPlayerTrade.Etat.ForeColor = 0
                    End If
                    Exit Sub
                End If
            Else
...
Dim Ending As String
    ...
    For i = 1 To 4
        ...
        If FileExist(App.Path & Rep_Theme & "\Jeu\echange" & Ending) Then Me.Picture = LoadPNG(App.Path & Rep_Theme & "\Jeu\echange" & Ending)
    Next i
End Sub
