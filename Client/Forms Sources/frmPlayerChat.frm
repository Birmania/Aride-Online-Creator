...
If keyCode = UserCommand.item("haut") Then frmMirage.SetFocus: Call CheckInput(1, keyCode, Shift)
If keyCode = UserCommand.item("bas") Then frmMirage.SetFocus: Call CheckInput(1, keyCode, Shift)
If keyCode = UserCommand.item("gauche") Then frmMirage.SetFocus: Call CheckInput(1, keyCode, Shift)
If keyCode = UserCommand.item("droite") Then frmMirage.SetFocus: Call CheckInput(1, keyCode, Shift)
If keyCode = UserCommand.item("courir") Then frmMirage.SetFocus: Call CheckInput(1, keyCode, Shift)
If keyCode = UserCommand.item("attaque") Then frmMirage.SetFocus: Call CheckInput(1, keyCode, Shift)
End Sub
...
'
'        Packet.WriteLong CSayOnChat
'        Packet.WriteString txtSay.Text
'
...
Dim Ending As String
    ...
    For i = 1 To 4
        ...
        If FileExist(App.Path & Rep_Theme & "\Jeu\chat" & Ending) Then Me.Picture = LoadPNG(App.Path & Rep_Theme & "\Jeu\chat" & Ending)
    Next i
End Sub
