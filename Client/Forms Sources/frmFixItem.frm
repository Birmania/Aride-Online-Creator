...
Dim Ending As String
    ...
    For i = 1 To 4
        ...
        If FileExist(App.Path & Rep_Theme & "\Jeu\reparer" & Ending) Then Me.Picture = LoadPNG(App.Path & Rep_Theme & "\Jeu\reparer" & Ending)
    Next i
    
    Label1.Font = ReadINI("POLICE", "Police", (ColorCOnfigurationFile))
    Label1.FontSize = ReadINI("POLICE", "PoliceSize", (ColorCOnfigurationFile))
End Sub
...
Private Sub cmbItem_Click()
    ...
    If item(GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex + 1)).Datas(0) > -1 And GetPlayerInvItemDur(MyIndex, cmbItem.ListIndex + 1) > -1 Then
        i = (item(GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex + 1)).Datas(0) - GetPlayerInvItemDur(MyIndex, cmbItem.ListIndex + 1)) * (item(GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex + 1)).Datas(1) / 5) \ 2
        If i <= 0 Then i = 1
