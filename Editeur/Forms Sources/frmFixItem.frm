...
Private Sub chkFix_Click()
    Call SendData("fixitem" & SEP_CHAR & cmbItem.ListIndex & SEP_CHAR & frmTrade.picFixItems.Tag & SEP_CHAR & END_CHAR)
    Call cmbItem_Click
End Sub

Private Sub cmbItem_Click()
    Dim i As Long
    If GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex) > 0 And GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex) < MAX_ITEMS Then
    If Item(GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex)).Data1 > -1 And GetPlayerInvItemDur(MyIndex, cmbItem.ListIndex) > -1 Then
        i = ((Item(GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex)).Data1 - GetPlayerInvItemDur(MyIndex, cmbItem.ListIndex)) * (Item(GetPlayerInvItemNum(MyIndex, cmbItem.ListIndex)).Data2 / 5)) \ 2
        If i <= 0 Then i = 1
